...
export function PeriodByBusinessTab({
  period,
  clientId,
  businessId,
  aeoPlanId,
  ...
  const groups = useMemo<BusinessGroup[]>(() => {
    ...
    return [...map.values()].sort((a, b) => {
      ...
      return a.businessName
        .toLowerCase()
        .localeCompare(b.businessName.toLowerCase());
    });
  }, [data]);
              ...
              <CardContent className="pt-0 pb-4">
                ...
                <div className="space-y-1">
                  {[...g.rows]
                    .sort(
                      (a, b) =>
                        a.keywordText.localeCompare(b.keywordText) ||
                        a.platform.localeCompare(b.platform),
                    )
                    .map((r) => (
                      <div
                        key={`${r.keywordId}-${r.platform}`}
                        className="grid grid-cols-12 gap-2 items-center text-sm px-2 py-1.5 rounded bg-muted/20"
                      >
