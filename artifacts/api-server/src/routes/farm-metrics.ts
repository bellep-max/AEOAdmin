...
const DEFAULT_METRICS = [
  /* ── Device Farm Performance ── */
  {
    ...
    description: "% of sessions using a different device from the previous one",
  ...
  },
  {
    ...
    description: "% of sessions using a unique IP/proxy address",
    category: "performance",
    unit: "%",
    targetValue: "90",
    isComputed: false,
  ...
  {
    key: "cache_clearing",
    label: "Cache Clearing Rate",
    description:
      "% of sessions where device cache is fully cleared before execution",
    category: "performance",
    unit: "%",
    targetValue: "100",
    isComputed: false,
  },
  {
    ...
    description:
      "% of sessions that complete successfully without error or timeout",
    category: "performance",
    unit: "%",
    targetValue: "95",
    isComputed: false,
  },
  {
    ...
    description:
      "Actual searches delivered vs. target search volume per billing cycle",
    category: "performance",
    unit: "%",
    targetValue: "98",
    isComputed: false,
  ...
  /* ── Device Health ── */
  {
    ...
    label: "Device Uptime",
    description:
      "% of the device fleet that is online and available for sessions",
  ...
  {
    key: "avg_battery_level",
    label: "Avg Battery Level",
    description: "Average battery % across all active devices in the farm",
    category: "device_health",
    unit: "%",
    targetValue: "60",
    isComputed: false,
  ...
  {
    key: "device_error_rate",
    label: "Device Error Rate",
    description:
      "% of sessions aborted due to device-level failures (crash, freeze, reboot)",
    category: "device_health",
    unit: "%",
    targetValue: "2",
    isComputed: false,
  ...
  {
    key: "reboot_frequency",
    label: "Reboot Frequency",
    description: "Average number of reboots per device per day",
    category: "device_health",
    unit: "/day",
    targetValue: "1",
    isComputed: false,
  ...
  /* ── Proxy / Network ── */
  {
    key: "proxy_success_rate",
    label: "Proxy Success Rate",
    description:
      "% of proxy connections that establish successfully without rotation failure",
  ...
  {
    key: "avg_session_latency",
    label: "Avg Session Latency",
    description:
      "Average time from session start to first AI platform response (seconds)",
    category: "proxy_network",
    unit: "s",
    targetValue: "4",
    isComputed: false,
  ...
  {
    key: "proxy_rotation_interval",
    label: "Proxy Rotation Interval",
    description: "Minimum sessions before the same proxy IP is reused",
    category: "proxy_network",
    unit: "sessions",
    targetValue: "5",
    isComputed: false,
  ...
  /* ── AEO Campaign ── */
  {
    key: "daily_target_achievement",
    label: "Daily Target Achievement",
    description:
      "% of daily search target delivered across all active client accounts",
    category: "campaign",
    unit: "%",
    targetValue: "100",
    isComputed: false,
  },
  {
    ...
    description:
      "% of active keywords that have been searched at least once in the last 24h",
    category: "campaign",
    unit: "%",
    targetValue: "100",
    isComputed: false,
  ...
  {
    key: "platform_gemini",
    label: "Platform — Gemini",
    description: "% of AEO sessions targeted at Google Gemini",
    category: "campaign",
    unit: "%",
    targetValue: "40",
    isComputed: false,
  ...
  {
    key: "platform_chatgpt",
    label: "Platform — ChatGPT",
    description: "% of AEO sessions targeted at ChatGPT (OpenAI)",
    category: "campaign",
    unit: "%",
    targetValue: "40",
    isComputed: false,
  ...
  {
    key: "platform_perplexity",
    label: "Platform — Perplexity",
    description: "% of AEO sessions targeted at Perplexity AI",
    category: "campaign",
    unit: "%",
    targetValue: "20",
    isComputed: false,
  ...
  /* ── Capacity ── */
  {
    key: "active_devices_target",
    label: "Active Devices Target",
    description: "Target number of devices actively running AEO sessions",
    category: "capacity",
    unit: "devices",
    targetValue: "30",
    isComputed: false,
  },
  {
    ...
    description: "Total AEO sessions executed across all devices per day",
    category: "capacity",
    unit: "sessions",
    targetValue: "300",
    isComputed: false,
  ...
  {
    key: "searches_per_device_day",
    label: "Searches / Device / Day",
    description:
      "Target number of AEO prompt searches each device executes per day",
    category: "capacity",
    unit: "searches",
    targetValue: "10",
    isComputed: false,
  },
  {
    ...
    description:
      "Maximum number of business clients the farm can serve concurrently",
    category: "capacity",
    unit: "clients",
    targetValue: "80",
    isComputed: false,
...
router.patch("/:key", requireAdmin, async (req, res) => {
  try {
    ...
    const { value, targetValue } = req.body as {
      value?: string;
      targetValue?: string;
    };
