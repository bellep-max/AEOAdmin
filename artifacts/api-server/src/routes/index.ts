...
import lockedKeywordsRouter from "./locked-keywords";
...
import reportHidesRouter from "./report-hides";
...
router.use("/report-hides", reportHidesRouter);
router.use("/keywords", keywordsRouter);
router.use("/admin/locked-keywords", lockedKeywordsRouter);
